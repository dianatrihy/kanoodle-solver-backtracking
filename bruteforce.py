...
def solve_brute_force(board, pieces):
    def list_all_placements(board, list_empty, piece):
        placements = []
        for shape in piece.shapes:
            for row, col in list_empty:
    ...
    list_all = []
    for piece in pieces:
        list_empty = board.list_empty_positions()
        placements = list_all_placements(board, list_empty, piece)
